...
<div class="super_container">
	...
	<div class="home">
		...
		<div class="home_content">
			<div class="home_content_inner">
				<div class="home_text_large">dhaka university</div>
				<div class="home_text_small">DU Lal Bus</div>
			</div>
		</div>
	</div>
	...
	<div class="find">
		...
		<div class="container">
			<div class="row">
				<div class="col-12">
					<div class="find_title text-center">Find a stoppage of any Du Lalbus</div>
				</div>
				<div class="col-12">
...
<!--							<div class="find_item">
	...
	<div class="video_section d-flex flex-column align-items-center justify-content-center">
		...
		<div class="video_content">
			<div class="video_title">Road view of University of Dhaka</div>
			<div class="video_subtitle">A video made by shopno production</div>
			<div class="video_play">
				<a  class="video" href="https://www.youtube.com/watch?v=cP3tSCQvZyA&feature=youtu.be">
